find_program(HT_OSSLSIGNCODE osslsigncode)

if(HT_OSSLSIGNCODE)
    execute_process(COMMAND ${HT_OSSLSIGNCODE} --version
...
find_package_handle_standard_args(HT_OSSLSIGNCODE
    REQUIRED_VARS HT_OSSLSIGNCODE HT_OSSLSIGNCODE_VERSION
    VERSION_VAR HT_OSSLSIGNCODE_VERSION
)

if(HT_OSSLSIGNCODE AND NOT HT_OSSLSIGNCODE_FOUND)
    set(HT_OSSLSIGNCODE 0 CACHE STRING "" FORCE)
endif()
